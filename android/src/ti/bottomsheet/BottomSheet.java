...
import ti.bottomsheet.adapter.DividableGridAdapter;
import ti.bottomsheet.model.AbstractItem;
import ti.bottomsheet.model.Divider;
import ti.bottomsheet.model.Item;
import ti.bottomsheet.view.DividableGridView;
import ti.bottomsheet.view.DraggableView;
 ...
 * Builder#show()} of the builder {@link ti.bottomsheet.BottomSheet.Builder} can be
 * used.
 *
 * @author Michael Rapp
 * @since 1.0.0
...
public class BottomSheet extends Dialog implements DialogInterface, DraggableView.Callback {
    ...
    public static class Builder {
        ...
        private void obtainStyledAttributes(@StyleRes final int themeResourceId) {
            ...
            obtainItemTitleColor(themeResourceId);
        ...
        private void obtainItemTitleColor(@StyleRes final int themeResourceId) {
            TypedArray typedArray = getContext().getTheme().obtainStyledAttributes(themeResourceId,
                    new int[]{R.attr.bottomSheetItemColor});
            int color = typedArray.getColor(0, -1);
        ...
        public final Builder setItemTitleColor(@ColorInt final int color) {
            bottomSheet.setItemTitleColor(color);
            return this;
        }
        ...
        public final Builder setItemColorAtIndex(@NonNull final int index, @ColorInt final int color) {

            bottomSheet.setItemColorAtIndex(index, color);
            return this;
        }
         ...
         * Builder}
         */
        public final Builder addItem(final int id, @NonNull final CharSequence title, final int color) {
            bottomSheet.addItem(id, title, color);
            return this;
        }
        ...
        public final Builder addItem(final int id, @NonNull final CharSequence title, final int color,
            ...
            bottomSheet.addItem(id, title, color, icon);
            return this;
        }
         ...
         * Builder}
         */
        public final Builder addItem(final int id, @StringRes final int titleId, final int color) {
            bottomSheet.addItem(id, titleId, color);
            return this;
        }
        ...
        public final Builder addItem(final int id, @StringRes final int titleId, final int color,
            ...
            bottomSheet.addItem(id, titleId, color, iconId);
            return this;
        }
     ...
     */
    private void adaptItemTitleColor() {
        if (titleTextView != null && itemTitleColor != -1) {
            titleTextView.setTextColor(itemTitleColor);
        }
    }
    ...
    // public final void setItemTitleColor(@ColorInt final int color) {
    //     titleColor = color;
    //     adaptTitleColor();
    // }
    ...
    public final int getItemTitleColor() {
        return adapter.getItemTitleColor();
    }

    public final void setItemTitleColor(@ColorInt final int color) {
        adapter.setItemTitleColor(color);
        adapter.notifyDataSetChanged();
    }
    ...
    public final void setItemColorAtIndex(@NonNull final int index, @ColorInt final int color) {
        adapter.setItemColorAtIndex(index,color);
        adapter.notifyDataSetChanged();
    }
    ...
    public final void addItem(final int id, @NonNull final CharSequence title, @ColorInt final int color) {
        Item item = new Item(id, title, color);
        adapter.add(item);
        adaptGridViewHeight();
    }
     ...
     *         Drawable}, or null, if no item should be used
     */
    public final void addItem(final int id, @NonNull final CharSequence title, final int color,
                              @Nullable final Drawable icon) {
        Item item = new Item(id, title, color);
        item.setIcon(icon);
        adapter.add(item);
     ...
     *         Integer} value. The resource id must correspond to a valid string resource
     */
    public final void addItem(final int id, @StringRes final int titleId, @ColorInt final int color) {
        Item item = new Item(getContext(), id, titleId, color);
        adapter.add(item);
        adaptGridViewHeight();
    }
     ...
     *         CharSequence}. The title may neither be null, nor empty
     */
    public final void setItem(final int index, final int id, @NonNull final CharSequence title, final int color) {
        Item item = new Item(id, title, color);
    ...
    //     @Override
    // public final void setItemTitleColor(@Nullable final int color) {
    //     super.setItemTitleColor(color);
     ...
     *         Integer} value. The resource id must correspond to a valid string resource
     */
    public final void setItem(final int index, final int id, @StringRes final int titleId, @ColorInt final int color) {
        Item item = new Item(getContext(), id, titleId, color);
        adapter.set(index, item);
        adaptGridViewHeight();
    }
    ...
    public final void setIntent(@NonNull final Activity activity, @NonNull final Intent intent) {
        ...
        for (int i = 0; i < resolveInfos.size(); i++) {
            ...
            addItem(i, resolveInfo.loadLabel(packageManager), 0, resolveInfo.loadIcon(packageManager));
        }
    ...
    public final Bundle onSaveInstanceState() {
        ...
        outState.putInt(TITLE_COLOR_EXTRA, itemTitleColor);
    ...
    public final void onRestoreInstanceState(@NonNull final Bundle savedInstanceState) {
        ...
        setItemTitleColor(savedInstanceState.getInt(TITLE_COLOR_EXTRA));
