...
public class Item extends AbstractItem {
     ...
     */
    public Item(final int id, @NonNull final CharSequence title, final int color) {
     ...
     */
    public Item(@NonNull final Context context, final int id, @StringRes final int resourceId, final int color) {
        this(id, context.getText(resourceId), color);
    }
    ...
    public final void setItemTitleColor(@NonNull final int color) {
    ...
    public final Item clone() {
        Item clonedItem = new Item(getId(), getTitle(), getItemTitleColor());
